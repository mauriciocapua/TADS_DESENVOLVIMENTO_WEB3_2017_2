 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://cobaia1server/", wsdlLocation = "http://EREBUS:8080/Cobaia1Server/ServerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://cobaia1server/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://EREBUS:8080/Cobaia1Server/ServerService?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://cobaia1server/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cobaia1server/", "ServerPort"), Server.class, features);
    }
