...
public class ServerServiceLocator extends org.apache.axis.client.Service implements cobaia1server.ServerService {
    ...
    private java.lang.String ServerPort_address = "http://EREBUS:8080/Cobaia1Server/ServerService";
    ...
    public cobaia1server.Server getServerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cobaia1server.ServerPortBindingStub _stub = new cobaia1server.ServerPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cobaia1server.Server.class.isAssignableFrom(serviceEndpointInterface)) {
                cobaia1server.ServerPortBindingStub _stub = new cobaia1server.ServerPortBindingStub(new java.net.URL(ServerPort_address), this);
                _stub.setPortName(getServerPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://cobaia1server/", "ServerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://cobaia1server/", "ServerPort"));
        }
