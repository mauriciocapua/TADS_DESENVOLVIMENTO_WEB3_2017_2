 ...
 * generated in the cobaia3server package. 
...
public class ObjectFactory {
    ...
    private final static QName _Authenticate_QNAME = new QName("http://cobaia3server/", "authenticate");
    private final static QName _AuthenticateResponse_QNAME = new QName("http://cobaia3server/", "authenticateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cobaia3server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cobaia3server/", name = "authenticate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cobaia3server/", name = "authenticateResponse")
